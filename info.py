...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1786851907 7689365869').split()] # Replace with the actual admin ID(s) to add
