...
API_ID = int(environ.get('API_ID', '34059790')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '99f6bded8d3691f3abe6696e96aaae73')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8775078253:AAFVu3OPBYvMb3RXUEpDk2deF0xKD9FfyGg")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://walter-white-5462.rihanrazak765.workers.dev')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7689365869 1786851907').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003720104763 -1002755250239').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003780122688'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003780122688'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003780122688'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003637535615').split()] #(make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/HodyCloud')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003872373910")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-100")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/5d052e95e84d5884ecef3-13a5aff067a1fecb89.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@hodystoll@upi')    # Owner UPI ID for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003893096290'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/HodyCloud")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/HodyCloud")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HodyCloud")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MalluMoviePort') # Group link for the bot
