...
BOT_TOKEN = environ.get('BOT_TOKEN', "8708205938:AAGt2cv3WeC0AH5pXTkmDHDaWUDWMjfAYlk")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://walter-white-73c8.rihanrazak765.workers.dev/')).split() #random anime girl img each time from aniwallpaper (Experimental)
